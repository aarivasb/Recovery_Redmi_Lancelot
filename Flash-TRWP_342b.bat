@title Recovery TRWP 3.4.2b Redmi 9 Lancelot - by Alfredo Rivas - @aarivasb
@color 4f
...
@pause>nul
@fastboot flash recovery lancelot_recovery342b.img
@timeout /t 3
...
@echo Presione tecla para continuar...
@pause>nul
@fastboot boot lancelot_recovery342b.img
@timeout /t 3
